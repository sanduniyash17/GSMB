          ...
          <Grid item xs={12}>
            <Card>
              <div style={borderStyle}>
                <h2 style={{ textAlign: 'center' }}>DELIVERED ORDER</h2>
                <Divider />
                {/* <CardContent> */}
                  <div style={formBorder}>
                    ...
                    <label htmlFor="deliveryConfirmationBy">
                      Delivery Confirmation By:
                    </label>
                    <input
                      type="text"
                      id="deliveryConfirmationBy"
                      name="deliveryConfirmationBy"
                      value={formData.deliveryConfirmationBy}
                      onChange={handleChange}
                      required
                      style={inputStyle}
                    />
...
DeliveredOrder.getLayout = (page) => <SidebarLayout>{page}</SidebarLayout>;
