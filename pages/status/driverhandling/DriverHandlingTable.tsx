...
interface DriverHandlingTableProps {
  className?: string;
...
const DriverHandlingTable: FC<DriverHandlingTableProps> = ({
  cryptoOrders
}) => {
...
DriverHandlingTable.propTypes = {
  cryptoOrders: PropTypes.array.isRequired
};

DriverHandlingTable.defaultProps = {
  cryptoOrders: []
};

export default DriverHandlingTable;
