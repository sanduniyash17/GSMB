...
interface MiningPointRegistrationTableProps {
  className?: string;
...
const MiningPointRegistrationTable: FC<MiningPointRegistrationTableProps> = ({
  cryptoOrders
}) => {
              ...
              >
                {paginatedCryptoOrders.map((cryptoOrder) => (
                  <tr hover key={cryptoOrder.id}>
                    ...
                    <td>{cryptoOrder.miningPointNumber}</td>
                    <td>{cryptoOrder.miningPointLicenseNumber}</td>
                    <td>{cryptoOrder.ownerName}</td>
                    <td>{cryptoOrder.contactNumber}</td>
                    <td>{cryptoOrder.miningPointLocation}</td>
...
MiningPointRegistrationTable.propTypes = {
  cryptoOrders: PropTypes.array.isRequired
};

MiningPointRegistrationTable.defaultProps = {
  cryptoOrders: []
};

export default MiningPointRegistrationTable;
