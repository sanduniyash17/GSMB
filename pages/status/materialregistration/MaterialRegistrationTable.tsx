...
interface MaterialRegistrationTableProps {
  className?: string;
...
const MaterialRegistrationTable: FC<MaterialRegistrationTableProps> = ({
  cryptoOrders
}) => {
              ...
              >
                {paginatedCryptoOrders.map((cryptoOrder) => (
                  <tr hover key={cryptoOrder.id}>
                    <td>{cryptoOrder.materialName}</td>
                    <td>{cryptoOrder.materialSize}</td>
                    <td>
                      <div
                        style={{
                          display: 'flex',
...
MaterialRegistrationTable.propTypes = {
  cryptoOrders: PropTypes.array.isRequired
};

MaterialRegistrationTable.defaultProps = {
  cryptoOrders: []
};

export default MaterialRegistrationTable;
