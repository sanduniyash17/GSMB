...
interface ViewConfirmOrderTableProps {
  className?: string;
...
const ViewConfirmOrderTable: FC<ViewConfirmOrderTableProps> = ({
  cryptoOrders
}) => {
              ...
              >
                {paginatedCryptoOrders.map((cryptoOrder) => (
                  <tr hover key={cryptoOrder.id}>
                    ...
                    <td>{cryptoOrder.statusOfDelivery}</td>
...
ViewConfirmOrderTable.propTypes = {
  cryptoOrders: PropTypes.array.isRequired
};

ViewConfirmOrderTable.defaultProps = {
  cryptoOrders: []
};

export default ViewConfirmOrderTable;
