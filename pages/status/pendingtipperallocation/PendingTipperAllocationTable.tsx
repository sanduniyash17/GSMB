...
interface PendingTipperAllocationTableProps {
  columns: Column[];
  data: Row[];
}

const PendingTipperAllocationTable: FC<PendingTipperAllocationTableProps> = ({ columns, data }) => {
...
export default PendingTipperAllocationTable;
