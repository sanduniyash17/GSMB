...
const UserAllocationTable: FC<UserAllocationTableProps> = ({
  cryptoOrders
}) => {
              ...
              >
                {paginatedCryptoOrders.map((cryptoOrder) => (
                  <tr hover key={cryptoOrder.id}>
                    <td>{cryptoOrder.companyType}</td>
                    <td>{cryptoOrder.employeeId}</td>
                    <td>{cryptoOrder.employeeName}</td>
                    <td>{cryptoOrder.userRole}</td>
                    <td>{cryptoOrder.password}</td>
                    <td>{cryptoOrder.confirmPassword}</td>
...
UserAllocationTable.defaultProps = {
  cryptoOrders: []
};
