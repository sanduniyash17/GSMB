...
interface PendingPaymentVerificationTableProps {
  columns: Column[];
  data: Row[];
}

const PendingPaymentVerificationTable: FC<PendingPaymentVerificationTableProps> = ({ columns, data }) => {
...
export default PendingPaymentVerificationTable;
