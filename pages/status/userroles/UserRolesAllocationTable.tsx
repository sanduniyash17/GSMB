...
interface UseRolesrAllocationTableProps {
  className?: string;
...
const UseRolesrAllocationTable: FC<UseRolesrAllocationTableProps> = ({
  cryptoOrders
}) => {
              ...
              >
                {paginatedCryptoOrders.map((cryptoOrder) => (
                  <tr hover key={cryptoOrder.id}>
                    <td>{cryptoOrder.userRoleId}</td>
                    <td>{cryptoOrder.userRole}</td>
...
UseRolesrAllocationTable.propTypes = {
  cryptoOrders: PropTypes.array.isRequired
};

UseRolesrAllocationTable.defaultProps = {
  cryptoOrders: []
};

export default UseRolesrAllocationTable;
