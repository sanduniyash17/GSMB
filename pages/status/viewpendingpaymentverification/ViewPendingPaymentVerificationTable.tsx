...
interface ViewPendingPaymentVerificationTableProps {
  className?: string;
...
const ViewPendingPaymentVerificationTable: FC<
  ViewPendingPaymentVerificationTableProps
> = ({ cryptoOrders }) => {
            ...
            >
              ...
              >
                <tr style={{ padding: '10px', fontWeight: 'normal' }}>
                  <th style={{ padding: '10px', fontWeight: 'normal' }}>ID</th>
              ...
              >
                {paginatedCryptoOrders.map((cryptoOrder) => (
                  <tr hover key={cryptoOrder.id}>
                    ...
                    <td>{cryptoOrder.paymentReciept}</td>
                    <td>{cryptoOrder.paymentStatus}</td>
...
ViewPendingPaymentVerificationTable.propTypes = {
  cryptoOrders: PropTypes.array.isRequired
};

ViewPendingPaymentVerificationTable.defaultProps = {
  cryptoOrders: []
};

export default ViewPendingPaymentVerificationTable;
